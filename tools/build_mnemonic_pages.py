...
SUBJECTS = [
    ...
    ('법제도',  '06-법제도',   '법제도',            '법제도<br>기술사 정리',       '법률 · 인증제도 · 가이드라인'),
    ('신기술',  '07-신기술',   '신기술',            '신기술<br>기술사 정리',       '최신 기술 트렌드 · 가트너 전략기술'),
    ('보안',    '08-보안',     '정보보안',          '정보보안<br>기술사 정리',     '보안 개요 · 암호화 · 네트워크/시스템 보안'),
    ('빅데',    '09-빅데이터', '빅데이터 분석',      '빅데이터<br>기술사 정리',     '분석 기획 · 거버넌스 · 기법'),
    ('프관',    '10-프로젝트관리', '프로젝트 관리',  '프로젝트관리<br>기술사 정리', 'PMBOK · ISO 21500 · 관리 지식영역'),
    ('NW',      '11-네트워크', '네트워크',          '네트워크<br>기술사 정리',     'OSI · 프로토콜 · 접속장치'),
    ('CAOS',    '12-caos',     '컴퓨터구조/운영체제', 'CA·OS<br>기술사 정리',      '운영체제 · 컴퓨터 아키텍처'),
    ('알고리즘','13-알고리즘', '자료구조/알고리즘',  '알고리즘<br>기술사 정리',     '자료구조 · 알고리즘 분류'),
    ('디패',    '14-uml디자인패턴', 'UML/디자인패턴', 'UML·디자인패턴<br>기술사 정리', '객체지향 · GoF 패턴'),
    ('IT뉴스',  '15-it뉴스',   'IT 뉴스 토픽',       'IT뉴스<br>기술사 정리',      '최신 이슈 · 추가 토픽'),
]
